...
import { deleteUser, getUser, insertUserObject, responseObject }
from 'src/common/dto/api.dto';
import { UserEntity } from 'src/common/entity/authuser.entity';
import { ILike, Like, Repository } from 'typeorm';
@Injectable()
export class ApiService {
constructor(
@InjectRepository(UserEntity) private readonly user:
...
async createUser(userData: insertUserObject) :
...
async deleteUser(userData: deleteUser) :
Promise<responseObject> {
